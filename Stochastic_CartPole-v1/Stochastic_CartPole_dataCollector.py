...
class Config:
    ...
    ckpt_path: str = "Stochastic_CartPole-v1/Stochastic_CartPole-v1_medium.pt" 
    save_name: str = "Stochastic_CartPole-v1/Stochastic_D_CartPole_medium_mixed.npz"
...
if __name__ == "__main__":
    ...
    cfg = Config(
        env_id="CartPole-v1",
        ckpt_path="Stochastic_CartPole-v1/Stochastic_CartPole-v1_medium.pt",
        save_name="Stochastic_CartPole-v1/Stochastic_D_CartPole_medium_mixed.npz",
